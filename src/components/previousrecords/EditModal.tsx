...
const EditModal = () => {
    ...
    return (
        <Fragment>
            <motion.dialog id={`modal-${context.record.id}`} className=" bg-[#1B1F38] text-white shadow-2xl modal fixed z-20 p-8 m-5 rounded-xl top-[25%] left-[100vw/2] md:left-[40%]" open={context.isModalOpen}
            ...
            >
                ...
                >
                    ...
                    <form className='flex flex-col gap-4' onSubmit={(e) => submitChanges(e)}>
                        <div className='grid grid-cols-2  max-w-[20rem] gap-4'>
